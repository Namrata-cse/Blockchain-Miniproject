...
class Miner:
    ...
    def __init__(self, window, master, last_hash):
        if (os.path.exists("results.txt")):
            ...
            l = Label(window, text="No transaction in the pool.")
    ...
    def add(self, transactions, window, master, last_hash):
        ...
        self.b = Button(mine_window, text="Start Mining",
    ...
    def next(self, transactions, T, total, window, master):
        ...
        if (self.count == total):
            ...
            end_window.title("Transactions")
            end_window.geometry('400x120')
            l = Label(end_window, text="End of transactions")
            b = Button(end_window, text="Go back to Login", command=lambda: self.exit(master, window, end_window))
            l.pack()
            b.pack()
        else:
